...
is $errors[0]->message, 'Missing property: lastName', 'required';
is_deeply $errors[0]->TO_JSON, {path => '/lastName', message => 'Missing property: lastName', rule => '{Example Schema}'}, 'TO_JSON';
